...
.contact-inner{max-width:640px;margin:0 auto;text-align:center;margin-bottom:20px}
...
.contact-section > .contact-inner > p{
  color:rgba(250,248,244,0.45);font-size:0.98rem;line-height:1.72;
}
.contact-cta{
  display:inline-block;background:var(--orange);color:#fff;
  padding:16px 40px;border-radius:100px;font-size:0.95rem;font-weight:600;
  transition:background 0.2s,transform 0.15s;
}
.contact-cta:hover{background:var(--orange2);transform:translateY(-1px)}
.calendly-wrap{
  max-width:820px;margin:40px auto 0;border-radius:20px;overflow:hidden;
...
@media(max-width:640px){
  ...
  .play-ring svg{width:22px;height:22px}
...
@media(max-width:420px){
  ...
  .btn-primary,.btn-ghost,.contact-cta{padding:13px 24px;font-size:0.86rem;width:100%;text-align:center}
...
<section class="contact-section" id="contact">
  <div class="contact-inner">
    ...
    <p>If you are ready to stop explaining your offer on every call and want a system that does it for you, book a 30-minute call directly below.</p>
  </div>
  <div class="calendly-wrap">
    <div class="calendly-inline-widget" data-url="https://calendly.com/maliksuhail2034/30min?hide_gdpr_banner=1&background_color=111108&text_color=faf8f4&primary_color=e8531a" style="min-width:280px;height:700px;"></div>
  </div>
  <p style="text-align:center;margin-top:18px;font-size:0.85rem;color:rgba(250,248,244,0.4)">
    Prefer email? <a href="mailto:suhail@necxmedia.com" style="color:var(--orange);font-weight:600">suhail@necxmedia.com</a>
  </p>
</section>
