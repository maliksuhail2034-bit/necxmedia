...
.nav-logo{font-family:'Fraunces',serif;font-weight:800;font-size:1.12rem;letter-spacing:0.08em;color:var(--dark);white-space:nowrap}
.nav-links{list-style:none;display:flex;gap:32px}
.nav-links a{font-size:0.82rem;font-weight:500;color:var(--mid);letter-spacing:0.02em;transition:color 0.18s;white-space:nowrap}
...
/* YouTube embed player — fixed 16:9 that never crops or distorts */
.yt-wrap{
...
/* padding-top hack guarantees a true 16:9 box on every browser/breakpoint,
   so the iframe is never stretched taller than its content (which reads as "cropped") */
...
max-width:680px;margin:0 auto 80px;width:100%;
}
.funnel-stage{
...
.funnel-stage-left{display:flex;align-items:center;gap:16px;min-width:0}
.funnel-stage-icon{
...
.contact-inner{max-width:640px;margin:0 auto;text-align:center;display:flex;flex-direction:column;align-items:center}
...
color:rgba(250,248,244,0.45);font-size:0.98rem;line-height:1.72;margin-bottom:40px;max-width:480px;
}
.contact-email-link{
...
.system-grid{grid-template-columns:repeat(2,1fr);gap:16px}
.svc{padding:36px 30px}
.funnel-visual{max-width:600px}
.funnel-stage:nth-child(2) .funnel-stage-inner{margin:0 26px}
.funnel-stage:nth-child(3) .funnel-stage-inner{margin:0 52px}
.funnel-stage:nth-child(4) .funnel-stage-inner{margin:0 78px}
.funnel-stage:nth-child(5) .funnel-stage-inner{margin:0 104px}
}
...
.proof-bar-inner{grid-template-columns:repeat(2,1fr);row-gap:36px}
...
.proof-bar-inner{gap:24px;row-gap:32px}
...
.funnel-stage:nth-child(1) .funnel-stage-inner{margin:0 0px}
.funnel-stage:nth-child(2) .funnel-stage-inner{margin:0 8px}
.funnel-stage:nth-child(3) .funnel-stage-inner{margin:0 16px}
.funnel-stage:nth-child(4) .funnel-stage-inner{margin:0 24px}
.funnel-stage:nth-child(5) .funnel-stage-inner{margin:0 32px}
}
...
.nav-btn{padding:8px 16px;font-size:0.76rem}
}
...
.btn-primary,.btn-ghost{padding:13px 24px;font-size:0.86rem;width:100%}
.hero-actions{width:100%}
.funnel-outcome-pill{font-size:0.72rem;padding:8px 14px;white-space:normal}
...
.contact-section > .contact-inner > p{margin-bottom:32px}
...
Video not loading? <a href="https://youtu.be/Df_MkNlI9CM" target="_blank" style="color:var(--orange);font-weight:600">Watch it directly on YouTube</a>
</p>
</div>
...
<a href="mailto:suhail@necxmedia.com" class="btn-primary" style="background:var(--orange)">suhail@necxmedia.com</a>
</div>
</section>
